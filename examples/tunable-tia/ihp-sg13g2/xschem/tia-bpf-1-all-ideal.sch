...
C {sg13g2_pr/annotate_fet_params.sym} 30 -410 0 0 {name=annot1 ref=M1}
C {capa.sym} 440 -550 0 0 {name=C1
m=1
value=@cap_size
footprint=1206
device="ceramic capacitor"}
C {capa.sym} 940 -550 0 0 {name=C2
m=1
value=@cap_size
footprint=1206
device="ceramic capacitor"}
C {res.sym} 500 -250 0 0 {name=R1
value=@res_s_size
footprint=1206
device=resistor
m=1}
C {res.sym} 840 -250 0 0 {name=R2
value=@res_s_size
footprint=1206
device=resistor
m=1}
C {res.sym} 670 -460 1 1 {name=R3
value=@res_z_size
footprint=1206
device=resistor
m=1}
