...
N 840 -220 920 -220 {lab=#net1}
N 420 -280 500 -280 {lab=inp}
N 500 -280 560 -280 {lab=inp}
N 500 -220 560 -220 {lab=#net2}
...
N 500 -220 500 -200 {lab=#net2}
N 420 -220 500 -220 {lab=#net2}
N 840 -220 840 -200 {lab=#net1}
N 760 -220 840 -220 {lab=#net1}
N 840 -140 840 -110 {lab=vss}
...
C {devices/lab_pin.sym} 500 -120 0 0 {name=p16 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 840 -110 0 1 {name=p17 sig_type=std_logic lab=vss}
C {sg13g2_pr/annotate_fet_params.sym} 3.75 -642.5 0 0 {name=annot1 ref=M1}
C {capa.sym} 420 -250 0 0 {name=C1
m=1
value=\{x_dut_cap_size\}
footprint=1206
device="ceramic capacitor"}
C {capa.sym} 920 -250 0 0 {name=C2
m=1
value=\{x_dut_cap_size\}
footprint=1206
device="ceramic capacitor"}
C {res.sym} 500 -550 0 0 {name=R1
value=\{x_dut_res_load_size\}
footprint=1206
device=resistor
m=1}
C {res.sym} 840 -550 0 0 {name=R2
value=\{x_dut_res_load_size\}
footprint=1206
device=resistor
m=1}
C {res.sym} 1100 -410 0 0 {name=R3
value=\{x_dut_res_2_size\}
footprint=1206
device=resistor
m=1}
C {res.sym} 300 -400 0 1 {name=R4
value=\{x_dut_res_2_size\}
footprint=1206
device=resistor
m=1}
C {ammeter.sym} 500 -170 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
C {ammeter.sym} 840 -170 0 0 {name=Vmeas1 savecurrent=true spice_ignore=0}
