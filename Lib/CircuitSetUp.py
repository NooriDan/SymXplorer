...
class CircuitSetUp:
    ...
    def __init__(self, 
                _output: List[sympy.Basic] = [Vop, Von], 
                _input: List[sympy.Basic] = [Vip, Vin],
                transmissionMatrixType="symbolic", 
                T_analysis=GlobalVariables.transmissionMatrix,
                solveFor = [
                  Vin, V2a, V2b, V1a, V1b, Va, Vb, Von, Vop, Vip, Vx,
                  Iip, Iin, I1a, I1b, I2a, I2b
                ],
                equations = GlobalVariables.nodalEquations,
                impedancesToDisconnect = GlobalVariables.impedancesToDisconnect,
                alwaysConnectedImpedances = []
):
    ...
    def _setPossibleImpedanceConnections(self):
        ...
        print("--- Impedance connections stored in BaseTransferFunction.impedanceConnections---")
